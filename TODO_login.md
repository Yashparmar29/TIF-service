# TODO for Fixing Login Button Functionality

- [x] Modify login.html JavaScript to handle login and registration using localStorage
  - [x] Add functions to store and retrieve users from localStorage
